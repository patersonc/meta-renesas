...
FILESPATH:append = ":${COREBASE}/meta/recipes-connectivity/openssh/openssh:"
SRC_URI += " \
           file://sshd_config \
           file://ssh_config \
           file://init \
...
USERADD_PARAM:${PN}-sshd = "--system --no-create-home --home-dir ${localstatedir}/run/sshd --shell /bin/false --user-group sshd"
...
EXTRA_OECONF:append:libc-musl = " --disable-wtmp"
...
RRECOMMENDS:${PN}-sshd:append:class-target = " rng-tools"
