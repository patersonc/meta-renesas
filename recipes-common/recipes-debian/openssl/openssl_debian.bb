...
FILESPATH:append = ":${COREBASE}/meta/recipes-connectivity/openssl/openssl:${COREBASE}/meta/recipes-connectivity/openssl/files:"
SRC_URI += " \
           file://run-ptest \
...
RPROVIDES:openssl-conf = "openssl10-conf"
RREPLACES:openssl-conf = "openssl10-conf"
RCONFLICTS:openssl-conf = "openssl10-conf"
